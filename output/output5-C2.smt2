...
(declare-fun index0 (Int) Bool) ; index0 = [Select]: SELECT s.name = user FROM Student AS s WHERE s.Student_id = self
...
(declare-fun val-index0-expr4 (Int) String) ; val-index0-expr4 = user
(declare-fun val-index0-res (Int) BOOL) ; val-index0-res = s.name = user
...
(assert (forall ((x Int)) (=> (index0 x) (= (val-index0-expr4 x) user))))
(assert (forall ((x Int)) (=> (index0 x) (= (= (val-index0-res x) TRUE) (and (not (= (val-index0-expr3 x) nullString)) (not (= (val-index0-expr4 x) nullString)) (= (val-index0-expr3 x) (val-index0-expr4 x)))))))
(assert (forall ((x Int)) (=> (index0 x) (= (= (val-index0-res x) FALSE) (and (not (= (val-index0-expr3 x) nullString)) (not (= (val-index0-expr4 x) nullString)) (not (= (val-index0-expr3 x) (val-index0-expr4 x))))))))
(assert (forall ((x Int)) (=> (index0 x) (= (= (val-index0-res x) NULL) (or (= (val-index0-expr3 x) nullString) (= (val-index0-expr4 x) nullString))))))
(assert (not (or (and (= (name_Student self) nullString) (= user nullString)) (and (= (name_Student self) user) (not (or (= (name_Student self) nullString) (or (= self nullClassifier) (= self invalidClassifier)) (= user nullString) (= user invalidString)))))))
