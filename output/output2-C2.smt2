...
(assert (Student self))
(assert (and (distinct 18 nullInt) (distinct 18 invalidInt)))
(declare-sort BOOL 0)
...
(declare-fun index0 (Int) Bool) ; index0 = [Select]: SELECT s.age >= 18 FROM Student AS s WHERE s.Student_id = self
...
(declare-fun val-index0-expr3 (Int) Int) ; val-index0-expr3 = s.age
(declare-fun val-index0-expr4 (Int) Int) ; val-index0-expr4 = 18
(declare-fun val-index0-res (Int) BOOL) ; val-index0-res = s.age >= 18
...
(assert (forall ((x Int)) (=> (index0 x) (= (val-index0-expr3 x) (val-indexStudent-age x)))))
(assert (forall ((x Int)) (=> (index0 x) (= (val-index0-expr4 x) 18))))
(assert (not (= 18 nullInt)))
(assert (not (= 18 invalidInt)))
(assert (forall ((x Int)) (=> (index0 x) (= (= (val-index0-res x) TRUE) (and (not (= (val-index0-expr3 x) nullInt)) (not (= (val-index0-expr4 x) nullInt)) (>= (val-index0-expr3 x) (val-index0-expr4 x)))))))
(assert (forall ((x Int)) (=> (index0 x) (= (= (val-index0-res x) FALSE) (and (not (= (val-index0-expr3 x) nullInt)) (not (= (val-index0-expr4 x) nullInt)) (not (>= (val-index0-expr3 x) (val-index0-expr4 x))))))))
(assert (forall ((x Int)) (=> (index0 x) (= (= (val-index0-res x) NULL) (or (= (val-index0-expr3 x) nullInt) (= (val-index0-expr4 x) nullInt))))))
(assert (not (and (>= (age_Student self) 18) (not (or (= (age_Student self) nullInt) (or (= self nullClassifier) (= self invalidClassifier)) false false)))))
(assert (forall ((x Int)) (=> (index0 x) (= (val-index0-res x) TRUE))))
(check-sat)
