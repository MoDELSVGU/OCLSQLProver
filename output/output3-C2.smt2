...
(assert (not (forall ((s Classifier)) (and (=> (Student s) (forall ((l Classifier)) (and (=> (Enrolment l s) (and (> (age_Lecturer l) (age_Student s)) (not (or (= (age_Lecturer l) nullInt) (or (= l nullClassifier) (= l invalidClassifier)) (= (age_Student s) nullInt) (or (= s nullClassifier) (= s invalidClassifier)))))) (not (or (= s nullClassifier) (= s invalidClassifier)))))) (not false)))))
